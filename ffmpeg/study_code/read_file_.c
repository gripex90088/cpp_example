...
int main(int argc, char *argv[]) {
	...
	if (argc < 2) {
		av_log(NULL, AV_LOG_DEBUG, "The count of parameter should be more than two\n");
		exit(1);
	}

	av_log(NULL, AV_LOG_DEBUG, "The count of parameter\n");
	...
	av_log(NULL, AV_LOG_DEBUG, "open file\n");
